...
GroupName = 'SFTPLogging/LoggingGroupProd'
roleName = "SFTPLogging"
policyName = "SFTPLogging"
trailName = "Logging-Prod"
...
clg = a.create_log_group(logGroupName=GroupName, tags=tags)
...
rolecreate = b.create_role(Path='/', RoleName=roleName, AssumeRolePolicyDocument=assumestatement, Description=RoleDescription, tags=tags)
...
createtrail = c.create_trail(Name=trailName, S3BucketName=s3bucketName, S3KeyPrefix=s3keyPrefix, IsMultiRegionTrail="true", CloudWatchLogsLogGroupArn=grouparn, CloudWatchLogsRoleArn=rolearn, TagsList=tags)
