...
varspath = "/opt/Cloud-Engineering/ansible/win_ec2_configure/group_vars/all/"
varsfile = "vars.yml"
...
#print("The " + server_count, server + " with the prefix " + server_name + " took " + BuildTime + " to complete.")
