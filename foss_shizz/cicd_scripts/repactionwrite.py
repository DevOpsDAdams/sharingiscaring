...
WaveSSMName = '<<secret_name_1>>'
ReplicationActionSSMName = '<<secret_name_2>>'
UserSSMName = '<<secret_name_3>>'
LoginPassSecretName = '<<secret_name_4>>'
CETokenSecretName = '<<secret_name_5>>'
ceServerList = '<<secret_name_6>>'
