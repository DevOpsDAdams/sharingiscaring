...
'''
az role assignment create --assignee <<object_id>> --role Contributor --scope /subscriptions/<<subscription_id>>/resourceGroups/<<resource_group>>
az ad sp create-for-rbac -n "<<service_principal_name>>" --output YAML
