...
module "servers" {
  ...
  network_interface_ip_configuration_subnet_ids                     = data.azurerm_subnet.subnet.id
  ...
  managed_disk_names                                                = var.json.vm_info[count.index].disk_names
  ...
  linux_vm_enabled                                                  = var.json.vm_info[count.index].linux_vm
