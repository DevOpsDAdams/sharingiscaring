...
resource "azurerm_linux_virtual_machine" "this" {
  ...
  admin_ssh_key {
    username   = "oavmadmin"
    public_key = file("../modules/linux-virtual-machine/.ssh/oavmadmin_rsa.pub")
  }
...
resource "azurerm_security_center_server_vulnerability_assessment" "linuxsolution_vulnerability" {
  virtual_machine_id = azurerm_linux_virtual_machine.this.id
  depends_on = [
    azurerm_linux_virtual_machine.this,
